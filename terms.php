...
<div class="max-w-4xl mx-auto py-12">
    ...
    <div class="bg-white rounded-3xl border border-slate-200 p-8 md:p-12 shadow-premium relative overflow-hidden mb-8">
        <span class="text-slate-400 text-sm mb-8 block">Effective Date: <?php echo date('F d, Y'); ?></span>
        ...
        <ul class="list-disc pl-5 text-slate-600 text-sm space-y-2 mt-2 mb-4">
        ...
        <p class="text-slate-600 text-sm leading-relaxed text-justify mb-0">
