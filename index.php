...
<div class="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center mb-20">
    ...
    <div class="lg:col-span-7 text-left space-y-6">
        <div class="inline-flex items-center bg-primary-50 border border-primary-100 text-primary-600 px-4 py-1.5 rounded-full text-xs font-black uppercase tracking-wider">
        ...
        <div class="flex flex-col sm:flex-row gap-4 pt-2">
            <?php if (isLoggedIn()): ?>
                <?php if (isAdmin()): ?>
                    <a href="admin/dashboard.php" class="bg-primary-600 hover:bg-primary-700 text-white font-bold px-8 py-3.5 rounded-full shadow-lg hover:scale-105 transition-all text-sm flex items-center justify-center sm:justify-start w-full sm:w-auto">
                        Admin Portal <i class="fas fa-arrow-right ml-2 text-sm"></i>
                    </a>
                <?php else: ?>
                    <a href="student/dashboard.php" class="bg-primary-600 hover:bg-primary-700 text-white font-bold px-8 py-3.5 rounded-full shadow-lg hover:scale-105 transition-all text-sm flex items-center justify-center sm:justify-start w-full sm:w-auto">
                        Start Learning <i class="fas fa-arrow-right ml-2 text-sm"></i>
                    </a>
                <?php endif; ?>
            <?php else: ?>
                <a href="register.php" class="bg-primary-600 hover:bg-primary-700 text-white font-bold px-8 py-3.5 rounded-full shadow-lg hover:scale-105 transition-all text-sm text-center w-full sm:w-auto">Get Started Free</a>
                <a href="login.php" class="border border-slate-200 text-slate-700 hover:bg-slate-50 font-bold px-8 py-3.5 rounded-full transition-all text-sm text-center w-full sm:w-auto">Sign In</a>
            <?php endif; ?>
        </div>
        ...
        <div class="grid grid-cols-3 gap-4 pt-6 border-t border-slate-100 max-w-md">
            <div>
                ...
                <div class="text-slate-400 text-sm font-bold uppercase tracking-wider">Active Users</div>
            </div>
            <div>
                <div class="font-extrabold text-slate-900 text-base mb-0.5">500+</div>
                <div class="text-slate-400 text-sm font-bold uppercase tracking-wider">Quizzes</div>
            </div>
            <div>
                <div class="font-extrabold text-slate-900 text-base mb-0.5">4.9/5</div>
                <div class="text-slate-400 text-sm font-bold uppercase tracking-wider">User Rating</div>
            </div>
        </div>
    </div>
    ...
    <div class="lg:col-span-5 relative hidden lg:block">
        <div class="w-full h-[400px] rounded-[48px] bg-gradient-to-tr from-primary-50 to-primary-100/50 border border-primary-100/40 relative overflow-hidden flex items-center justify-center">
            ...
            <div class="absolute top-10 left-6 bg-white border border-slate-200 rounded-3xl p-4 shadow-premium flex items-center w-56 animate-float-1">
                ...
                <div class="min-w-0">
                    <h6 class="font-extrabold text-slate-800 text-sm truncate">Top Scorer</h6>
                    <span class="text-slate-400 text-sm font-bold uppercase tracking-wider block">Achieve Greatness</span>
                </div>
            </div>
            ...
            <div class="absolute bottom-12 left-10 bg-white border border-slate-200 rounded-3xl p-5 shadow-premium w-48 text-center animate-float-2">
                <span class="text-sm font-bold text-slate-400 uppercase tracking-widest block mb-1">XP Points</span>
            ...
            <div class="absolute top-36 right-4 bg-white border border-slate-200 rounded-3xl p-4 shadow-premium flex items-center w-52 animate-float-3">
                ...
                <div class="min-w-0">
                    <h6 class="font-extrabold text-slate-800 text-sm">Quiz Passed</h6>
                    <span class="text-emerald-500 text-sm font-bold block">Score: 92%</span>
                </div>
            </div>
        </div>
    </div>
...
<section class="py-12 position-relative">
    <div class="flex flex-col md:flex-row justify-between items-start md:items-end mb-10 gap-4">
        <div>
            <h6 class="text-primary-600 text-sm uppercase font-extrabold tracking-widest mb-2">Curated for you</h6>
        ...
        <div class="hidden md:block flex-shrink-0">
            <a href="student/quizzes.php" class="text-primary-600 hover:text-primary-700 font-bold text-sm inline-flex items-center group transition-colors">
                Browse All Categories <i class="fas fa-chevron-right ml-1.5 text-sm group-hover:translate-x-1 transition-transform"></i>
            </a>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div class="group bg-white rounded-3xl border border-slate-200 shadow-sm overflow-hidden hover:shadow-premium hover:-translate-y-2 transition-all duration-300 p-6 relative">
            ...
            <div class="relative z-1">
                ...
                <p class="text-slate-400 text-sm leading-relaxed mb-6">Master Python, Java, and modern web frameworks.</p>
                <div class="flex items-center justify-between">
                    <span class="bg-primary-50 text-primary-600 text-sm font-bold px-3 py-1 rounded-full">120+ Quizzes</span>
        ...
        <div class="group bg-white rounded-3xl border border-slate-200 shadow-sm overflow-hidden hover:shadow-premium hover:-translate-y-2 transition-all duration-300 p-6 relative">
            ...
            <div class="relative z-1">
                ...
                <p class="text-slate-400 text-sm leading-relaxed mb-6">Explore Biology, Chemistry, and Quantum Physics.</p>
                <div class="flex items-center justify-between">
                    <span class="bg-accent-50 text-accent-600 text-sm font-bold px-3 py-1 rounded-full">85+ Quizzes</span>
        ...
        <div class="group bg-white rounded-3xl border border-slate-200 shadow-sm overflow-hidden hover:shadow-premium hover:-translate-y-2 transition-all duration-300 p-6 relative">
            ...
            <div class="relative z-1">
                ...
                <p class="text-slate-400 text-sm leading-relaxed mb-6">From basic Algebra to advanced Calculus.</p>
                <div class="flex items-center justify-between">
                    <span class="bg-amber-50 text-amber-600 text-sm font-bold px-3 py-1 rounded-full">60+ Quizzes</span>
        ...
        <div class="group bg-white rounded-3xl border border-slate-200 shadow-sm overflow-hidden hover:shadow-premium hover:-translate-y-2 transition-all duration-300 p-6 relative">
            ...
            <div class="relative z-1">
                ...
                <p class="text-slate-400 text-sm leading-relaxed mb-6">Journey through civilizations and turning points.</p>
                <div class="flex items-center justify-between">
                    <span class="bg-sky-50 text-sky-600 text-sm font-bold px-3 py-1 rounded-full">95+ Quizzes</span>
...
<section class="py-12">
    <div class="max-w-xl mx-auto text-center mb-12">
        <h6 class="text-primary-600 text-sm uppercase font-extrabold tracking-widest mb-2">Process</h6>
        ...
        <div class="bg-white rounded-3xl border border-slate-200 p-8 shadow-sm hover:shadow-premium hover:-translate-y-2 transition-all duration-300 text-center relative h-full">
            <div class="flex justify-center mb-6">
                <div class="relative">
                    ...
                    <span class="absolute -top-1.5 -right-1.5 w-5 h-5 rounded-full bg-primary-600 text-white text-xs font-bold flex items-center justify-center border-2 border-white shadow-sm">1</span>
                </div>
            </div>
            <h4 class="font-bold text-slate-900 text-base mb-3">Sign Up</h4>
            <p class="text-slate-400 text-sm leading-relaxed">Create your free account in seconds. Join a community of eager learners.</p>
        </div>
        ...
        <div class="bg-white rounded-3xl border border-slate-200 p-8 shadow-sm hover:shadow-premium hover:-translate-y-2 transition-all duration-300 text-center relative h-full">
            <div class="flex justify-center mb-6">
                <div class="relative">
                    ...
                    <span class="absolute -top-1.5 -right-1.5 w-5 h-5 rounded-full bg-primary-600 text-white text-xs font-bold flex items-center justify-center border-2 border-white shadow-sm">2</span>
                </div>
            </div>
            <h4 class="font-bold text-slate-900 text-base mb-3">Take Quizzes</h4>
            <p class="text-slate-400 text-sm leading-relaxed">Choose from a variety of categories and challenge yourself with interactive quizzes.</p>
        </div>
        ...
        <div class="bg-white rounded-3xl border border-slate-200 p-8 shadow-sm hover:shadow-premium hover:-translate-y-2 transition-all duration-300 text-center relative h-full">
            <div class="flex justify-center mb-6">
                <div class="relative">
                    ...
                    <span class="absolute -top-1.5 -right-1.5 w-5 h-5 rounded-full bg-primary-600 text-white text-xs font-bold flex items-center justify-center border-2 border-white shadow-sm">3</span>
                </div>
            </div>
            <h4 class="font-bold text-slate-900 text-base mb-3">Get Results</h4>
            <p class="text-slate-400 text-sm leading-relaxed">Receive instant feedback, track your progress, and climb the leaderboard.</p>
        </div>
    </div>
</section>
...
<section class="py-12 text-center">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
        <div class="bg-white rounded-3xl border border-slate-200 p-8 shadow-sm hover:shadow-premium hover:-translate-y-1 transition-all duration-300 h-full">
            ...
            <p class="text-slate-400 text-sm leading-relaxed">Get detailed explanations and scores immediately after completing a quiz.</p>
        </div>
        <div class="bg-white rounded-3xl border border-slate-200 p-8 shadow-sm hover:shadow-premium hover:-translate-y-1 transition-all duration-300 h-full">
            ...
            <p class="text-slate-400 text-sm leading-relaxed">Track your progress over time with comprehensive charts and performance reports.</p>
        </div>
        <div class="bg-white rounded-3xl border border-slate-200 p-8 shadow-sm hover:shadow-premium hover:-translate-y-1 transition-all duration-300 h-full">
            ...
            <p class="text-slate-400 text-sm leading-relaxed">Study on the go. Our platform is fully responsive and optimized for any device.</p>
        </div>
    </div>
</section>
...
<section class="py-12 mb-8">
    <div class="max-w-xl mx-auto text-center mb-12">
        <h6 class="text-amber-500 text-sm uppercase font-extrabold tracking-widest mb-2">Testimonials</h6>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div class="bg-white rounded-3xl border border-slate-200 p-8 shadow-sm hover:shadow-premium hover:-translate-y-2 transition-all duration-300 relative overflow-hidden group flex flex-col h-full">
            ...
            <div class="flex items-center mt-auto relative z-1">
                <div class="w-10 h-10 rounded-full bg-gradient-to-tr from-rose-500 to-rose-400 text-white font-bold flex items-center justify-center shadow-md shadow-rose-500/10 mr-3 text-sm">JS</div>
                <div>
                    <h6 class="text-slate-800 mb-0 font-bold text-sm">John Smith</h6>
                    <small class="text-slate-400 text-xs">Computer Science Student</small>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-3xl border border-slate-200 p-8 shadow-sm hover:shadow-premium hover:-translate-y-2 transition-all duration-300 relative overflow-hidden group flex flex-col h-full">
            ...
            <div class="flex items-center mt-auto relative z-1">
                <div class="w-10 h-10 rounded-full bg-gradient-to-tr from-emerald-500 to-emerald-400 text-white font-bold flex items-center justify-center shadow-md shadow-emerald-500/10 mr-3 text-sm">ED</div>
                <div>
                    <h6 class="text-slate-800 mb-0 font-bold text-sm">Emily Davis</h6>
                    <small class="text-slate-400 text-xs">Lifelong Learner</small>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-3xl border border-slate-200 p-8 shadow-sm hover:shadow-premium hover:-translate-y-2 transition-all duration-300 relative overflow-hidden group flex flex-col h-full">
            ...
            <div class="flex items-center mt-auto relative z-1">
                <div class="w-10 h-10 rounded-full bg-gradient-to-tr from-sky-500 to-sky-400 text-white font-bold flex items-center justify-center shadow-md shadow-sky-500/10 mr-3 text-sm">MJ</div>
                <div>
                    <h6 class="text-slate-800 mb-0 font-bold text-sm">Michael Johnson</h6>
                    <small class="text-slate-400 text-xs">Web Developer</small>
                </div>
            </div>
        </div>
    </div>
