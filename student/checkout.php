...
<div class="container py-5">
    <div class="row justify-content-center">
        <div class="col-lg-6">
            <h2 class="text-light fw-bold mb-4"><i class="fas fa-lock text-success me-2"></i> Secure Checkout</h2>
            ...
            <div class="card glass-card border-0 shadow-lg p-4">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center mb-4 pb-3 border-bottom border-light border-opacity-10">
                        <div>
                            <h5 class="text-light mb-1">Premium Mode: <?php echo sanitize($quiz['title']); ?></h5>
                    ...
                    <form action="../controllers/dummy-payment-process.php" method="POST">
                        ...
                        <div class="mb-4 opacity-50 pe-none">
                            <label class="form-label text-light small fw-bold">Name on Card</label>
                            <input type="text" class="form-control bg-dark border-secondary text-light" value="<?php echo sanitize($_SESSION['username']); ?>" readonly>
                        </div>
                        
                        <div class="mb-4 opacity-50 pe-none">
                            <label class="form-label text-light small fw-bold">Card Details</label>
                            <input type="text" class="form-control bg-dark border-secondary text-light font-monospace" value="**** **** **** 4242" readonly>
                        </div>
