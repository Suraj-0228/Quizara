    ...
    <div class="row justify-content-center">
        <div class="col-lg-8 col-xl-6 text-center">
            ...
            <div class="mb-4">
                ...
                <h1 class="display-5 fw-bold text-light">Unlock Premium High Mode</h1>
                <p class="lead text-muted">Take your skills to the ultimate level with the hardest questions in <strong class="text-white"><?php echo sanitize($quiz['title']); ?></strong>.</p>
            </div>
                ...
                <div class="card-body p-5">
                    ...
                    <ul class="list-unstyled text-start mb-5 mx-auto" style="max-width: 300px;">
                        <li class="mb-3 d-flex align-items-center">
                            ...
                            <span class="text-light">Access to 'High' difficulty mode</span>
                        </li>
                        <li class="mb-3 d-flex align-items-center">
                            <div class="me-3 rounded-circle bg-success bg-opacity-20 p-1 d-flex align-items-center justify-content-center text-success" style="width: 24px; height: 24px;"><i class="fas fa-check small"></i></div>
                            <span class="text-light">Exclusive Premium Certificate</span>
                        </li>
                        <li class="mb-3 d-flex align-items-center">
                            <div class="me-3 rounded-circle bg-success bg-opacity-20 p-1 d-flex align-items-center justify-content-center text-success" style="width: 24px; height: 24px;"><i class="fas fa-check small"></i></div>
                            <span class="text-light">Support the creators</span>
                        </li>
                    </ul>
