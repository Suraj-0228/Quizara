        ...
        <div class="col-lg-8">
            ...
            <div class="glass-card border-0 shadow-lg position-relative overflow-hidden">
                <div class="card-header bg-transparent border-bottom border-secondary border-opacity-25 py-3 px-4">
                    <h5 class="mb-0 fw-bold"><i class="fas fa-edit me-2 text-primary"></i> Edit Question</h5>
                </div>
                    ...
                    <form action="" method="POST">
                        ...
                        <div class="mb-5">
                            ...
                            <div class="position-relative">
                                <textarea class="form-control premium-control bg-white text-slate-800 border-slate-200 ps-4 pt-3" id="question_text" name="question_text" rows="3" required placeholder="Type your question here..." style="min-height: 100px; font-size: 1.1rem; box-shadow: none;"><?php echo sanitize($question['question_text']); ?></textarea>
                                ...
                                <?php for ($i = 0; $i < 4; $i++): ?>
                                    ...
                                    <div class="col-md-6">
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control bg-white text-slate-800 border-slate-200" name="options[]" placeholder="Option <?php echo $i + 1; ?>" value="<?php echo $opt_val; ?>" required>
                                        </div>
                                    </div>
                                <?php endfor; ?>
                            </div>
                        ...
                        <div class="mb-5">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <input type="number" class="form-control bg-white text-slate-800 border-slate-200 text-center mx-2" id="marks" name="marks" value="<?php echo $question['marks']; ?>" min="1" style="width: 80px;">
