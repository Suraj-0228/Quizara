...
<div class="container-fluid py-4">
    ...
    <div class="row g-4 mb-4">
        <div class="col-md-8">
            <h2 class="fw-bold mb-1">Inbox</h2>
        ...
        <div class="col-md-4">
            <div class="d-flex gap-3 justify-content-md-end">
                <div class="glass-card p-3 rounded-4 d-flex align-items-center flex-grow-1 flex-md-grow-0 min-w-150">
                    ...
                    <div>
                        <div class="h5 fw-bold text-dark mb-0"><?php echo $total_messages; ?></div>
                ...
                <div class="glass-card p-3 rounded-4 d-flex align-items-center flex-grow-1 flex-md-grow-0 min-w-150">
                    ...
                    <div>
                        <div class="h5 fw-bold text-dark mb-0"><?php echo $today_count; ?></div>
        ...
        <div class="card-body p-0">
                            ...
                            <div class="row align-items-center g-3">
                                ...
                                <div class="col-lg-3 d-flex align-items-center">
                                    ...
                                    <div class="overflow-hidden">
                                        <h6 class="fw-bold mb-0 text-truncate text-slate-800"><?php echo sanitize($msg['name']); ?></h6>
                                ...
                                <div class="col-lg-6 cursor-pointer" data-bs-toggle="modal" data-bs-target="#viewModal<?php echo $msg['id']; ?>">
                                    <div class="d-flex flex-column">
                                        <span class="fw-medium mb-1 text-truncate text-slate-700"><?php echo sanitize($msg['subject']); ?></span>
                                ...
                                <div class="col-lg-3 text-lg-end">
                                    ...
                                    <div class="action-buttons opacity-0 transition-all">
                                        <button class="btn btn-icon btn-sm btn-outline-primary rounded-circle" data-bs-toggle="modal" data-bs-target="#viewModal<?php echo $msg['id']; ?>" title="View">
            ...
            <?php else: ?>
                <div class="text-center py-5 my-5">
                    <div class="bg-indigo-50 d-inline-block p-4 rounded-circle mb-3">
                    ...
                    <ul class="pagination justify-content-center mb-0">
                        ...
                        <?php for ($i = 1; $i <= $total_pages; $i++): ?>
                            <li class="page-item <?php echo $page == $i ? 'active' : ''; ?>">
                                <a class="page-link <?php echo $page == $i ? 'bg-primary border-primary text-white text-shadow-none' : 'bg-white text-slate-600 border-slate-200'; ?> mx-1 rounded-circle d-flex align-items-center justify-content-center" style="width: 35px; height: 35px;" href="?page=<?php echo $i; ?>&search=<?php echo urlencode($search); ?>">
                                    <?php echo $i; ?>
                                </a>
                            </li>
                        <?php endfor; ?>
    ...
    <div class="modal fade" id="viewModal<?php echo $msg['id']; ?>" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content bg-white border-0 shadow-lg rounded-4">
                <div class="modal-header border-bottom border-slate-100 py-3 px-4">
                    <div class="d-flex align-items-center">
                        <div class="avatar-circle bg-<?php echo $color; ?> bg-opacity-10 text-<?php echo $color; ?> me-3 fw-bold">
                            <?php echo $initial; ?>
                        </div>
                        <div>
                            <h5 class="fw-bold mb-0"><?php echo sanitize($msg['name']); ?></h5>
                ...
                <div class="modal-body p-4 p-lg-5">
                    <div class="d-flex justify-content-between align-items-sm-center flex-column flex-sm-row mb-4 gap-3">
                        <h4 class="fw-bold mb-0"><?php echo sanitize($msg['subject']); ?></h4>
                        <div class="text-muted small bg-slate-50 px-3 py-1 rounded-pill border border-slate-100 text-nowrap">
                            <i class="far fa-clock me-2"></i><?php echo date('F j, Y \a\t h:i A', strtotime($msg['created_at'])); ?>
                        </div>
                    </div>
                    <div class="message-content text-slate-700 lh-lg p-4 rounded-4 bg-slate-50 border border-slate-100">
